      ...
      output += `
        <div class="card card-body mb-2">
          <div class="row>
            ...
            <div class="col-md-6">
              <span class="badge badge-primary">Stars: ${repo.stagazers_count}</span>
